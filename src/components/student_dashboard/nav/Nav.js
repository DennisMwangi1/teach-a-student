     ...
     <div className='bg-black text-white pb-10  rounded-tr-3xl rounded-tl-3xl '>
      ...
      <div className='flex justify-between mt-2'>
        ...
        <div >
          ...
          <button className='mr-16 bg-slate-500 p-2 font-bold text-white rounded-xl transition ease-in-out delay-50  hover:-translate-y-1 hover:scale-110 hover:bg-white hover:text-black duration-300'>Logout</button>
        </div>
      </div>
    </div>
  )
