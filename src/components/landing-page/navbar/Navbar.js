...
function Navbar({setStudentSignUp}) {
  return (
    ...
    <div className='navbar backdrop-opacity-50  bg-white/30 pb-12'>
        ...
        <button className='bg-yellow-300  p-2 rounded-full font-serif transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-gradient-to-r from-pink-500 to-yellow-500 duration-300' onClick={()=>setStudentSignUp(true)}>Sign up to be a Student</button>
