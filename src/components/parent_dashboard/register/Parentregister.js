...
function Parentregister({setRegLog,regLog, setParent}) {
  ...
  function handleSubmit(e) {
    e.preventDefault()
    setLoading(true)
    fetch('http://127.0.0.1:3000/parentsignup', {
      method: 'POST',
      headers: {
  ...
  <>
      {loading ?
        <div className='m-auto'>
          <iframe className='m-auto' src="https://giphy.com/embed/rIqUQgjJa5v7Z0gSmD" width="463" height="480" frameBorder="0" class="giphy-embed" title='gif' allowFullScreen></iframe>
        </div>
        :
