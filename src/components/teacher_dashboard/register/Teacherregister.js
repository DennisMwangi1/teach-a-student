...
function Teacherregister({login,setLogin,setTeacher}) {
    ...
    const [strongSbj,setStrongSbj] = useState('')
    ...
    function handleSubmit(e) {
        e.preventDefault()
        setLoading(true)
        fetch('http://127.0.0.1:3000/teachersignup', {
          method: 'POST',
          headers: {
        ...
        <>
            {loading ?
                <div className='m-auto'>
                    <iframe className='ml-[25em] mt-20' src="https://giphy.com/embed/rIqUQgjJa5v7Z0gSmD" width="463" height="300" frameBorder="0" class="giphy-embed" title='gif' allowFullScreen></iframe>
                </div>
                :
                <div className="bg-slate-400 w-9/12 rounded-3xl rounded-tl-3xl  m-auto mt-[-28px] ">
                    ...
                    <form className="pt-10 text-center flex p-2" onSubmit={handleSubmit}>
                        ...
                        <div className="">
                            ...
                            <label htmlFor="form">Email:</label><br></br>
                            <input
                                type="email"
                                name="email"
                                value={email}
                        ...
                        <div className="">
                            ...
                            />
                            <br></br>
                            <label htmlFor="text">Strong Subject: </label>
                            <br></br>
                            <input
                                type="text"
                                name="text"
                                value={strongSbj}
                                onChange={(e) => setStrongSbj(e.target.value)}
                                required
                            />
                            <br></br>
